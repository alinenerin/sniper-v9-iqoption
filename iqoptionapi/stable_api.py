...
class IQ_Option:
    ...
    def __init__(self, email, password, active_account_type="PRACTICE"):
        ...
        self.SESSION_HEADER = {
            "User-Agent": r"Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/130.0.0.0 Safari/537.36",
    ...
    def __get_digital_open(self):
        ...
        try:
            ...
            if not raw or "underlying" not in raw:
                return
            digital_data = raw["underlying"]
        except Exception:
            return
