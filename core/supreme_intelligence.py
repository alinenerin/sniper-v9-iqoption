...
class SupremeIntelligence:
    ...
    def get_full_analysis(self, ohlcv_df):
        ...
        analysis = {
            ...
            # Keep evidence stages observable; downstream fusion must not
            # overwrite the preliminary technical score.
            ...
            "agents": {"SMC": "executed", "VSA": "executed", "DARTS": anomaly_result.get("status", "executed"),
                       "NEWS_SENTIMENT": sent_details.get("status", "unavailable") if isinstance(sent_details, dict) else "unavailable"},
