...
fast_triage = os.getenv('FAST_TRIAGE', 'false').lower() == 'true'
...
MIN_M1 = int(os.getenv('MIN_M1_CANDLES', '100' if fast_triage else '1000'))
...
REQUEST_M1 = int(os.getenv('REQUEST_M1_CANDLES', '120' if fast_triage else '1000'))
